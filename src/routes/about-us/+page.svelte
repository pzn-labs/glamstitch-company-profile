      ...
      <div class="px-6 pt-10 pb-24 sm:pb-32 lg:col-span-7 lg:px-0 lg:pt-40 lg:pb-16 xl:col-span-6 flex items-center">
        <div class="mx-auto max-w-lg lg:mx-0 animate-fade-in-up duration-700 ease-out">
          ...
          <div class="mt-10 flex flex-col sm:flex-row items-center gap-4">
            <a href="/company-profile-sveltekit/services" class="rounded-md bg-indigo-600 px-5 py-3 text-sm font-semibold text-white shadow-md hover:bg-indigo-500 transition">
              Layanan Kami
            </a>
            <a href="/company-profile-sveltekit/about" class="text-sm font-semibold text-gray-900 dark:text-white hover:underline">
        ...
        <div class="mt-16 grid grid-cols-2 gap-8 sm:grid-cols-3 xl:col-span-2 xl:mt-0">
          ...
          <div>
            ...
            <ul class="mt-6 space-y-4">
              ...
              <li><a href="/company-profile-sveltekit" class="text-base text-gray-300 dark:text-gray-600 hover:text-blue-400 transition duration-200">Contact Us</a></li>
