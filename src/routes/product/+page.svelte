      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32 text-center">
        ...
        <div class="mb-6 flex justify-center">
          <div class="relative rounded-full px-4 py-1.5 text-sm text-gray-300 ring-1 ring-white/20 hover:ring-white/30 transition">
            ...
            <a href="/project-sveltekit/product" class="ml-1 font-semibold text-white hover:underline">
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
            ...
            <a href="/project-sveltekit#" class="text-sm font-semibold text-white hover:text-indigo-400 transition-all transform hover:scale-105">Jelajahi Lebih Lanjut <span aria-hidden="true">→</span></a>
          </div>
      </div>
    </div>
  </section>
      ...
      <div class="flex flex-col lg:flex-row items-center gap-10">
        ...
        <div class="w-full lg:w-1/2 text-center lg:text-left animate-fade-slide-right">
          ...
          <div class="mt-10 flex flex-col sm:flex-row lg:justify-start justify-center gap-4">
            <a
              href="/project-sveltekit/features"
            ...
            <a
              href="/project-sveltekit/company"
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-16">
      ...
      <div class="grid grid-cols-1 gap-y-12 gap-x-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="flex flex-col items-center text-center space-y-6">
          <a href="/project-sveltekit/tshirts" class="block w-full max-w-sm mx-auto group">
        ...
        <!-- Jaket -->
        <div class="flex flex-col items-center text-center space-y-6">
          <a href="/project-sveltekit/jacket" class="block w-full max-w-sm mx-auto group">
            <div class="overflow-hidden rounded-xl shadow-md transition-all duration-300 transform group-hover:scale-105">
              <img 
        ...
        <!-- Kemeja -->
        <div class="flex flex-col items-center text-center space-y-6">
          <a href="/project-sveltekit/kemeja" class="block w-full max-w-sm mx-auto group">
            <div class="overflow-hidden rounded-xl shadow-md transition-all duration-300 transform group-hover:scale-105">
              <img 
