      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
          <div class="relative rounded-full px-3 py-1 text-sm text-gray-400 ring-1 ring-white/10 hover:ring-white/20 dark:ring-gray-600 dark:hover:ring-gray-500 transition">
            ...
            <a href="/project-sveltekit/" class="font-semibold text-white hover:underline dark:text-gray-300 dark:hover:text-indigo-400">
        ...
        <div class="text-center">
          ...
          <div class="mt-10 flex items-center justify-center gap-x-6">
            <a href="/project-sveltekit/contact" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400 transition-all transform hover:scale-105">
              Pesan Sekarang
            </a>
            <a href="/project-sveltekit/product-list" class="text-sm font-semibold text-white hover:text-indigo-400 dark:text-gray-300 dark:hover:text-indigo-400 transition-all transform hover:scale-105">
...
<div class="relative overflow-hidden bg-white dark:bg-gray-900 z-0">
    ...
    <section aria-labelledby="sale-heading" class="relative mx-auto flex max-w-7xl flex-col items-center px-4 pt-24 text-center sm:px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:max-w-none">
        ...
        <a href="/project-sveltekit/#" class="mt-6 inline-block w-full rounded-md border border-transparent bg-gray-900 text-white px-8 py-3 font-medium hover:bg-gray-800 sm:w-auto focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:bg-indigo-600 dark:hover:bg-indigo-500">
        ...
        <div class="mx-auto max-w-2xl px-16 py-24 sm:px-16 lg:max-w-7xl lg:px-16">
          ...
          <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            ...
            <div class="group relative animate__animated animate__fadeIn animate__delay-500ms">
              <img src="assets/image/kemeja.jpg" alt="Kaos Glam Stitch warna hitam."
              ...
              <div class="mt-4 flex justify-between">
                <div>
                  <h3 class="text-sm text-gray-700 dark:text-white">
                    <a href="/project-sveltekit/#"><span aria-hidden="true" class="absolute inset-0"></span>Kemeja | Flannel</a>
                  </h3>
            ...
            <div class="group relative animate__animated animate__fadeIn animate__delay-800ms">
              ...
              <div class="mt-4 flex justify-between">
                <div>
                  <h3 class="text-sm text-gray-700 dark:text-white">
                    <a href="/project-sveltekit/#"><span aria-hidden="true" class="absolute inset-0"></span>Kemeja | Lengan Panjang</a>
                  </h3>
            ...
            <div class="group relative animate__animated animate__fadeIn animate__delay-1200ms">
              ...
              <div class="mt-4 flex justify-between">
                <div>
                  <h3 class="text-sm text-gray-700 dark:text-white">
                    <a href="/project-sveltekit/#"><span aria-hidden="true" class="absolute inset-0"></span>Kemeja | Lengan Pendek</a>
                  </h3>
            ...
            <div class="group relative animate__animated animate__fadeIn animate__delay-1500ms">
              ...
              <div class="mt-4 flex justify-between">
                <div>
                  <h3 class="text-sm text-gray-700 dark:text-white">
                    <a href="/project-sveltekit/#"><span aria-hidden="true" class="absolute inset-0"></span>Kemeja | Denim</a>
                  </h3>
                  <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Hitam</p>
                </div>
                <p class="text-sm font-medium text-gray-900 dark:text-white">Rp 525.000</p>
